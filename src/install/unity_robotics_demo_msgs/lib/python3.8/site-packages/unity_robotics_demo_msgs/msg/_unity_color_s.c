...
bool unity_robotics_demo_msgs__msg__unity_color__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("unity_robotics_demo_msgs.msg._unity_color.UnityColor", full_classname_dest, 52) == 0);
  }
  unity_robotics_demo_msgs__msg__UnityColor * ros_message = _ros_message;
  {  // r
...
PyObject * unity_robotics_demo_msgs__msg__unity_color__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("unity_robotics_demo_msgs.msg._unity_color");
