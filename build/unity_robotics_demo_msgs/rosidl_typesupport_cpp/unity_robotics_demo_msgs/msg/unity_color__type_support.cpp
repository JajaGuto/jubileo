...
static const _UnityColor_type_support_symbol_names_t _UnityColor_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, unity_robotics_demo_msgs, msg, UnityColor)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, unity_robotics_demo_msgs, msg, UnityColor)),
  }
};
...
{
  return &::unity_robotics_demo_msgs::msg::rosidl_typesupport_cpp::UnityColor_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, unity_robotics_demo_msgs, msg, UnityColor)() {
  return get_message_type_support_handle<unity_robotics_demo_msgs::msg::UnityColor>();
}
