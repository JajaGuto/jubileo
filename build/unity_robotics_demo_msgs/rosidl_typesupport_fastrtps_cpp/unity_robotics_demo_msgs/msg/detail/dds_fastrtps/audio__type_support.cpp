...
#include "unity_robotics_demo_msgs/msg/detail/audio__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const unity_robotics_demo_msgs::msg::Audio & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  unity_robotics_demo_msgs::msg::Audio & ros_message)
{
  // Member: data
  {
    cdr >> ros_message.data;
...
{
  auto typed_message =
    static_cast<const unity_robotics_demo_msgs::msg::Audio *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<unity_robotics_demo_msgs::msg::Audio *>(
    untyped_ros_message);
...
{
  return max_serialized_size_Audio(full_bounded, 0);
}
...
{
  return &unity_robotics_demo_msgs::msg::typesupport_fastrtps_cpp::_Audio__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, unity_robotics_demo_msgs, msg, Audio)() {
  return &unity_robotics_demo_msgs::msg::typesupport_fastrtps_cpp::_Audio__handle;
}
